  ...
  <div class="h-screen flow-root">
    ...
    <div class="p-6 w-full md:w-full mt-2 md:mt-0 md:mx-auto">
      ...
      <div class="overflow-scroll h-96 md:h-full rounded-2xl bg-white md:w-3/4 m-auto mt-4 shadow text-md md:text-lg flow-root font-extralight font-sans antialiased">
        <br>
        <p class="font-bold mt-10">Effective: January 31, 2022</p>
        <p>
          We respect your privacy and are committed to protecting it through our
          compliance with this privacy policy (<b>“Policy”</b>). This Policy
          describes the types of information we may collect from you or that you
          may provide (<b>“Personal Information”</b>) on the assetlog.co website
          (<b>“Website”</b>), <b>“Assetlog”</b> mobile application (<b>“Mobile Application”</b>), and any of their related
          ...
          is a legally binding agreement between you (“User”, “you” or “your”) and
          ...
          authority to bind such an entity to this agreement, in which case the
          ...
          the Services. By accessing and using the Services, you acknowledge that
        ...
        <section>
          ...
          <p>
            When you open the Website or use the Mobile Application, our servers
            automatically record information that your browser or device sends.
            This data may include information such as your device’s IP address and
            location, browser and device name and version, operating system type
            and version, language preferences, the webpage you were visiting
            before you came to the Services, pages of the Services that you visit,
            the time spent on those pages, the information you search for on the
            Services, access times and dates, and other statistics. Information
            collected automatically is used only to identify potential cases of
            abuse and establish statistical information regarding the usage and
            traffic of the Services. This statistical information is not otherwise
        ...
        <section>
          ...
          <p>
            If you wish to use some of the features offered on the Services, you
            will be asked to provide certain Personal Information (for example,
            your name and email address). We receive and store any information you
            knowingly provide to us when you create an account, or fill any forms
            on the Services. When required, this information may include the
            following:
          </p>
          ...
          <ul>
            ...
            <li>Basic personal information (such as name, country of residence,
                etc)</li>

            <li>Any other materials you willingly submit to us (such as articles,
                images, feedback, etc)</li>
          </ul>
          <p>
        ...
        <section>
          ...
          <p>
            ...
            we would be the data processor. Our role may also differ depending on
            the specific situation involving Personal Information. We act in the
            capacity of a data controller when we ask you to submit your Personal
            ...
            Information. We act in the capacity of a data processor in situations
            when you submit Personal Information through the Services. We do not
            ...
            make the Services available to you, or to meet a legal obligation, we
            may need to collect and use certain Personal Information. If you do
            not provide the information that we request, we may not be able to
        ...
        <section>
          ...
          <p>
            ...
            read by a web server in the domain that issued the cookie to you. If
            you choose to decline cookies, you may not be able to fully experience
            the features of the Services. You may learn more about cookies and how
          ...
          <p>
            ...
            statistical purposes. Please note that you have the ability to accept
            or decline cookies. Most web browsers automatically accept cookies by
            default, but you can modify your browser settings to decline cookies
            if you prefer.
          </p>
        </section>
        <section>
        ...
        <section>
          ...
          <p>
            ...
            and across third-party websites. However, some third-party websites
        ...
        <section>
          ...
          <p>
            ...
            send such emails. We will maintain the information sent via email in
        ...
        <section>
          ...
          <p>
            ...
            maintain the information sent via email in accordance with applicable
        ...
        <section>
          ...
          <p>The Services contain links to other resources that are not owned or controlled by us. Please be aware that we
            are not responsible for the privacy practices of such other resources or third parties. We encourage you to be
            aware when you leave the Services and to read the privacy statements of each and every resource that may collect
        ...
        <section>
          ...
          <p>Therefore, while we strive to protect your Personal Information, you acknowledge that (i) there are security
            and privacy limitations of the Internet which are beyond our control; (ii) the security, integrity, and privacy
            of any and all information and data exchanged between you and the Services cannot be guaranteed; and (iii) any
            such information and data may be viewed or tampered with in transit by a third party, despite best efforts.</p>
          <p>As the security of Personal Information depends in part on the security of the device you use to communicate
            with us and the security you use to protect your credentials, please take appropriate measures to protect this
            information.</p>
        </section>
        <section>
          <h2>Data breach</h2>
          <p>In the event we become aware that the security of the Services has been compromised or Users’ Personal
            ...
            required by law. When we do, we will post a notice on the Services, send you an email.</p>
        </section>
        <section>
          <h2>Changes and amendments</h2>
          <p>We reserve the right to modify this Policy or its terms related to the Services at any time at our discretion.
            When we do, we will revise the updated date at the top of this page. We may also provide notice to you in other
            ...
            otherwise specified. Your continued use of the Services after the effective date of the revised Policy (or such
            other act specified at that time) will constitute your consent to those changes. However, we will not, without
            your consent, use your Personal Information in a manner materially different from what was stated at the time
        ...
        <section>
          ...
          <p>You acknowledge that you have read this Policy and agree to all its terms and conditions. By accessing and
            using the Services and submitting your information you agree to be bound by this Policy. If you do not agree to
            abide by the terms of this Policy, you are not authorized to access or use the Services. </p>
        </section>
        <section>
          <h2>Contacting us</h2>
          <p>
            ...
            <br><span class="fa fa-envelope mt-2"></span> <a href="mailto:help@assetlog.co" class="font-bold">help@assetlog.co</a></p>
